...
func main() {
	...
	// output of client's parcels
	// there should not be the last parcel here, because it should have been successfully deleted
	err = service.PrintClientParcels(client)
	if err != nil {
		fmt.Println(err)
		return
